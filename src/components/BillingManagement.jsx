...
const BillingManagement = ({ showAccountMenu = true }) => {
  ...
  return (
    <div className="billing-page h-full overflow-y-auto overflow-x-hidden flex flex-col p-4 sm:p-6 gap-4 min-w-0">
      <div className="flex items-center justify-between gap-4 flex-wrap min-w-0">
        <div className="flex items-center gap-3 flex-wrap min-w-0">
          <h1 className="text-2xl font-bold text-neutral-200 flex items-center gap-2 min-w-0 break-words">
