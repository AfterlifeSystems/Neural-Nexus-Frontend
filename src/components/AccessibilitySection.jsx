...
/**
 * The Accessibility section of account settings: describe my surroundings,
 * and everything about it.
 *
 * The one mode here turns the phone into a pair of eyes that talk. The rear
 * camera is pointed at whatever is in front of the person — held up, or worn
 * on a lanyard — and every few seconds the avatar says what is there,
 ...
 * spoken aloud, and the section says in words what to do next rather than
 * showing it. The heading order is the outline a screen reader reads out.
 */
  ...
  return (
    ...
    >
      <header className="flex items-center gap-3">
        <MdAccessible
          className="w-6 h-6 shrink-0 text-amber-300"
          aria-hidden
        />
        <h2
      ...
      <div>
        ...
        >
          <MdAccessible className="w-5 h-5 shrink-0" aria-hidden />
          {sceneNarrationOn
        ...
        {/* Announced as well as shown: the state of this switch is the one
            thing in the section a person must never have to look to learn. */}
        <p
          role="status"
          aria-live="polite"
