...
export default function Careers() {
  return (
    <section
      id="careers"
      className="py-16 bg-black text-neutral-200"
    >
      <div className="container mx-auto flex flex-col items-center">
        ...
        <a
          ...
          className="text-3xl font-bold text-center mb-8 px-6 py-3 rounded-xl bg-black/50 border border-white/10 hover:bg-neutral-900 hover:border-neutral-200 transition-all duration-300 flex items-center gap-3 focus:outline-none focus:ring-2 focus:ring-amber-400/50"
        >
        ...
        <a
          href={`mailto:${WAITLIST_EMAIL}`}
          className="block text-center text-neutral-200 hover:underline hover:text-neutral-200 transition mt-2"
        >
          {WAITLIST_EMAIL}
        </a>
      </div>
